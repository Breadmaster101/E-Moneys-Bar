 ...
 * @param {boolean} [opts.inGame]    reveals the log button, the bell and the turn pill
 */
export function setTopbar({ back = false, backLabel = 'Back', inGame = false } = {}) {
